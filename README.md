...
This repository packages reusable Cursor and agent skills as plain Markdown-first folders. It is intended for simple GitHub browsing and ZIP download, especially when moving skills to another machine.
...
6. Restart Cursor and verify the skills are available.
